...
public class RingtonesAdapter extends ArrayAdapter<DrupalNode> {
    private RotateAnimation rotate=null;

	int resource;
    private ArrayList<DrupalNode> items;
    
	public RingtonesAdapter(Context _context, int _resource, List<DrupalNode> _items) {
